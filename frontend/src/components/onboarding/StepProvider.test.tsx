...
const activeGooglePreset: Preset = { ...samplePreset, id: 'google', label: 'Google', deferred: false }
...
describe('PresetCard', () => {
  ...
  it('does not disable google preset once unlocked', () => {
    render(<PresetCard preset={activeGooglePreset} selected={false} onSelect={() => {}} />)
