        ...
        <div className="mt-3 flex flex-col gap-3">
          ...
          {custom && (
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
              ...
              <input value={apiKey} onChange={(e) => setApiKey(e.target.value)} placeholder={t("settings.vision.apiKey")} className="rounded-lg border border-border bg-bg/30 px-3 py-1.5 text-[12px]" />
