...
it("tests and fetches models through the backend websocket", () => {
  ...
  fireEvent.click(getByText("Test", { selector: "button" }));
...
it("preserves legacy provider family values when editing", async () => {
  ...
  await waitFor(() => expect(getByDisplayValue("openai compatible")).toBeTruthy());
});
